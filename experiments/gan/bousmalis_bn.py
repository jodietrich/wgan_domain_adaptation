...
experiment_name = 'bousmalis_bn_dropout_keep0.9_10_noise_all_small_data_1e5l1_i1'
...
def generator(xs, training, scope_reuse=False, scope_name='generator'):
    return model_zoo.bousmalis_generator(xs, training, batch_normalization, residual_blocks=4, nfilters=8, input_noise_dim=10, scope_reuse=scope_reuse, scope_name=scope_name)
