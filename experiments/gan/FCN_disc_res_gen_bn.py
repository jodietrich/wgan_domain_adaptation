...
experiment_name = 'FCN_disc_res_gen_n64b3_all_small_data_0l1_bn_i1'
...
def generator(xs, training, scope_reuse=False, scope_name='generator'):
    return model_zoo.bousmalis_generator(xs, training, batch_normalization, residual_blocks=3, nfilters=64, input_noise_dim=0, scope_reuse=scope_reuse, scope_name=scope_name)
