...
# from batch_generator import iterate_minibatches_stratified, iterate_minibatches
...
# from experiments.multitask import debug_only_diag as exp_config
# from experiments.multitask import fcn_diag as exp_config
# from experiments.multitask import fcn_diag_noskull as exp_config
# from experiments.multitask import fcn_diag_nobn as exp_config
# from experiments.multitask import fcn_diag_nobn_sigmoid_noskull as exp_config
# from experiments.multitask import fcn_diag_noskull as exp_config
# from experiments.multitask import fcn_diag_noskull_smalldata as exp_config
# from experiments.multitask import fcn_diag_nobn_sigmoid as exp_config
# from experiments.multitask import fcn_diag_bren as exp_config
# from experiments.multitask import allconv_diag_noskull_smalldata as exp_config
from experiments.multitask import allconv_diag_noskull_cropdata as exp_config
...
def run_training(continue_run, log_dir):
    ...
    with tf.Graph().as_default():
        ...
        [loss, diag_loss, age_loss, weights_norm] = model_mt.loss(diag_logits,
                                                                  ...
                                                                  use_sigmoid=exp_config.use_sigmoid)
        ...
        for epoch in range(exp_config.max_epochs):
            ...
            # for batch in iterate_minibatches_stratified(images_train,
            #                                  labels_train,
            #                                  batch_size_per_class=exp_config.batch_size // exp_config.nlabels,
            ...
            #                                                      augment_batch=exp_config.augment_batch)):
                ...
                # define feed_dict, should be same for all operations below
                # Run accumulation
                feed_dict = {
                ...
                # logging.info('Doing a training step')
...
def do_eval(sess,
    ...
    # but at the risk of not catching exceptions
        ...
        # logging.info('DEBUG in eval')
        # logging.info(c_a_softmaxs)
        # logging.info(len(c_a_softmaxs))
        # logging.info(c_a_softmaxs[0].shape)
    ...
    logging.info(np.abs(np.asarray(predictions_ages, dtype=np.int32) - np.asarray(predictions_ages_gt,  dtype=np.int32)))
